...
import { Button, AppBar, Grid, Theme, Paper } from '@mui/material';
...
export default function Appbar() {
  ...
  window.addEventListener('scroll', debounce(scrollFun, 200));
  ...
  return (
    <div className={classes.rootStyle}>
      <AppBar position="fixed" className={classes.AppbarStyle}>
        <Paper elevation={0} className={classes.AppbarStyle}>
          <Grid container xs={12} className={classes.rootStyle}>
            <Grid item xs={4}>
              {showLogo ? (
                <Button
                  disableRipple
            ...
            <Grid item xs={6} className={classes.appbarRightButtonStyle}>
              {link.map((v, index) => (
                <AppbarButton
                  endPoint={v.endPoint}
